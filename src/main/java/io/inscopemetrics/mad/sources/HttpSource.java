...
import io.inscopemetrics.mad.http.RequestReply;
...
public class HttpSource extends ActorSource {
    ...
    private final Parser<List<Record>, io.inscopemetrics.mad.model.HttpRequest> _parser;
    ...
    static final class Actor extends AbstractActor {
        ...
        private static io.inscopemetrics.mad.model.HttpRequest mapModel(
                final Pair<ByteString, ImmutableMultimap<String, String>> pair) {
            return new io.inscopemetrics.mad.model.HttpRequest(pair.second(), pair.first());
        }

        private List<Record> parseRecords(final io.inscopemetrics.mad.model.HttpRequest request)
    ...
    public abstract static class Builder<B extends Builder<B, S>, S extends HttpSource> extends ActorSource.Builder<B, S> {
         ...
         * @return This builder
         */
        public B setParser(final Parser<List<Record>, io.inscopemetrics.mad.model.HttpRequest> value) {
            _parser = value;
            return self();
        }

        @NotNull
        private Parser<List<Record>, io.inscopemetrics.mad.model.HttpRequest> _parser;
    }
}
