...
/**
 * Implementation of the <code>Record</code> interface with Dimensions.
 *
 * @author Ryan Ascheman (rascheman at groupon dot com)
 */
@Loggable
public final class DimensionRecord implements Record {
    ...
    private DimensionRecord(final Builder builder) {
    ...
    /**
     * Implementation of builder pattern for <code>DimensionRecord</code>.
     *
