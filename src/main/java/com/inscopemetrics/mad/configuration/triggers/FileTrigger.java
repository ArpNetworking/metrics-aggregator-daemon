 ...
 */
package com.inscopemetrics.mad.configuration.triggers;
...
import com.inscopemetrics.mad.configuration.Trigger;
...
public final class FileTrigger implements Trigger {
    ...
    private @Nullable byte[] createHash(final File file) {
