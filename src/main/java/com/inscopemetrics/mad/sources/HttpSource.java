...
import com.inscopemetrics.mad.http.RequestReply;
...
public class HttpSource extends ActorSource {
    ...
    private final Parser<List<Record>, com.inscopemetrics.mad.model.HttpRequest> _parser;
    ...
    static final class Actor extends AbstractActor {
        ...
        private static com.inscopemetrics.mad.model.HttpRequest mapModel(
                final Pair<ByteString, ImmutableMultimap<String, String>> pair) {
            return new com.inscopemetrics.mad.model.HttpRequest(pair.second(), pair.first());
        }

        private List<Record> parseRecords(final com.inscopemetrics.mad.model.HttpRequest request)
    ...
    public abstract static class Builder<B extends Builder<B, S>, S extends HttpSource> extends ActorSource.Builder<B, S> {
         ...
         * @return This builder
         */
        public B setParser(final Parser<List<Record>, com.inscopemetrics.mad.model.HttpRequest> value) {
            _parser = value;
            return self();
        }

        @NotNull
        private Parser<List<Record>, com.inscopemetrics.mad.model.HttpRequest> _parser;
    }
}
