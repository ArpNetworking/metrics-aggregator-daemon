...
import io.inscopemetrics.mad.test.TestBeanFactory;
...
public final class CollectdHttpSourceV1Test extends BaseActorSourceTest {
    ...
    public void testParsesEntity() throws ParsingException {
        ...
        final ArgumentCaptor<io.inscopemetrics.mad.model.HttpRequest> captor =
                ArgumentCaptor.forClass(io.inscopemetrics.mad.model.HttpRequest.class);
