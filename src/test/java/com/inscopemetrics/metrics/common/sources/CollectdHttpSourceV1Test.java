...
public final class CollectdHttpSourceV1Test extends BaseActorSourceTest {
    ...
    public void testParsesEntity() throws ParsingException {
        ...
        final ArgumentCaptor<com.inscopemetrics.metrics.mad.model.HttpRequest> captor =
                ArgumentCaptor.forClass(com.inscopemetrics.metrics.mad.model.HttpRequest.class);
