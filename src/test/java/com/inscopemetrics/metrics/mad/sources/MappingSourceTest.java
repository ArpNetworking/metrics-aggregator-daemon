 ...
 */
package com.inscopemetrics.metrics.mad.sources;
...
import com.inscopemetrics.test.TestBeanFactory;
import com.inscopemetrics.test.UnorderedRecordEquality;
...
public class MappingSourceTest {
    ...
    public void testMergingMetricMergeMismatchedTypes() {
        final MappingSource.MergingMetric mergingMetric = new MappingSource.MergingMetric(
